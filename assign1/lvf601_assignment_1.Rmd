...
```{r, eval = F, code = readLines(here('scripts', 'LOAD.R')), echo = T}
```


### erdosRenyiNaive.R

```{r, eval = F, code = readLines(here('scripts', 'erdosRenyiNaive.R')), echo = T}
```

### erdosRenyiDiag.R

```{r, eval = F, code = readLines("scripts/erdosRenyiDiag.R"), echo = T}
```
